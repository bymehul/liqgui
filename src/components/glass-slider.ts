...
export class GlassSlider extends BaseElement {
    ...
    get value(): number { return parseFloat(this.getAttribute("value") || "50"); }
    ...
    private setupInteraction() {
        ...
        slider.addEventListener("touchstart", (e) => {
            this.isDragging = true;
            updateFromEvent(e as TouchEvent);
        }, { passive: true });
    ...
    private updateUI(animate = true) {
        ...
        const slider = this.root.querySelector(".slider");
        slider?.setAttribute("aria-valuenow", String(this.value));
    }
